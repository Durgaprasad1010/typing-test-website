...
const UpperMenu = ({ countDown, currWordIndex }) => {
    ...
    return (
        <div className="upper-menu">
            ...
            <div className="modes">
                <span className="mode" id='time' onClick={(e) => setMode(e)} style={{ paddingRight: '5px' }}>Time</span>
                <span>|</span>
                <span className="mode" id='words' onClick={(e) => setMode(e)} style={{ paddingLeft: '5px' }}>Words</span>
            </div>
            ...
            {testMode === 'time' ? (
                <div className="time-modes">
                    ...
                    <div className="time" id={120} onClick={(e) => updateTime(e)}>120s</div>
                </div>
            ) : (
                <div className="word-mode">
                    ...
                    <div className="no-of-words" id={60} onClick={(e) => updateWords(e)}>60</div>
                </div>
            )}
